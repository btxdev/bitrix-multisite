...
?>
    ...
    <div class="container">
        ...
        <h1 class="mt-4 mb-3">Велоцираптор Веган</h1>
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Велоцираптор Веган</li>
        </ol>
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                ...
                <a href="/images/blog_vegan.jpeg" data-fancybox data-caption="Велоцираптор Веган">
                    <img class="img-fluid rounded" src="/images/blog_vegan.jpeg" alt="Велоцираптор Веган">
                </a>

                <hr>
                <h6 class="card-subtitle mb-2 text-muted">Разное</h6>
                <p>Опубликовано три дня назад, автор: аноним</p>
